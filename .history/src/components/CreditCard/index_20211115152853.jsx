...
export default function CreditCard({name,number,valid}) {
  const styles = {
    container: "backdrop-filter backdrop-grayscale backdrop-blur-md backdrop-contrast-200 my-6 cursor-pointer w-full px-4  py-4 bg-gradient-to-r from-gray-50 to-gray-200 text-gray-600 shadow-2xl sm:rounded-3xl sm:p-6 bg-clip-padding bg-opacity-60 border border-gray-200",
    bankAxeptLogo: "w-1/6",
    wifiLogo: "ml-2 transform text-4xl rotate-90",
    number: "text-3xl font-bold filter blur-sm",
    texts:"flex justify-between mt-3 py-2 filter blur-sm",
  }
  return (
