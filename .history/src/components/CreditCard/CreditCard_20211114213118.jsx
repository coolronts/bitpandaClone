...
export default function CreditCard(props) {
  ...
  return (
    <div className ={container}>
      <div id={inner} class="w-full px-4  py-4 bg-gradient-to-r from-gray-50 to-gray-500 text-gray-600 shadow-2xl sm:rounded-3xl sm:p-6 bg-clip-padding bg-opacity-60 border border-gray-200" style={{backdropFilter: 'blur(60px)'}}>
