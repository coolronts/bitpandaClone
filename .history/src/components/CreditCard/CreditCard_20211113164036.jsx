...
export default function CreditCard() {
  ...
  return(
    <div class="relative px-4 w-1/3 py-4 bg-gray-200 text-gray-600 shadow-2xl sm:rounded-3xl sm:p-10 bg-clip-padding bg-opacity-60 border border-gray-200" style={{backdropFilter: 'blur(60px)'}}>
