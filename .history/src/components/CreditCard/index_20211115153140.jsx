...
export default function CreditCard({name,number,valid}) {
  const styles = {
    container: "backdrop-filter backdrop-blur-lg my-6 cursor-pointer w-full px-4  py-4 bg-gray-100text-gray-600 shadow-2xl sm:rounded-3xl sm:p-6 bg-clip-padding bg-opacity-60 border border-gray-200",
    bankAxeptLogo: "w-1/6",
