...
export function Circle({ icon, color, name, radius=24 }) {
  const styles = {
    base: `rounded-full h-${radius} w-${radius} flex items-center justify-center shadow-2xl bg-${color}-500 ring-1 ring-gray-900 hover:bg-${color}-400 cursor-pointer`,
    green: ``,
  }
  return (
