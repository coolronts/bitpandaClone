...
export function SmallSquare({  color, name }) {
  const styles = {
    container: `flex items-center justify-center shadow-2xl bg-${color}-400 ring-1 ring-gray-900 hover:bg-${color}-500 hover:shadow-none cursor-pointer`,
    name: `text-sm font-bold text-gray-600`
  }
  return (
    <div className={styles.container}>
      <p className={styles.name}>{name}</p>
