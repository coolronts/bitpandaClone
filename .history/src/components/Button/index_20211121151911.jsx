...
export function SmallSquare({  colour, name }) {
  const styles = {
    container: `flex items-center justify-center shadow-2xl bg-${colour}-400 ring-1 ring-gray-900 hover:bg-${colour}-500 hover:shadow-none cursor-pointer`,
