...
export default function Tables({
  ...
  const styles = {
    ...
    dataCell: "px-6 py-4 whitespace-nowrap font-semibold text-lg bg-red-200 w-4 h-4",
              ...
              <tbody className={styles.body}>
                {items.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className={`${styles.dataCell +  "bg-red-200 w-8 h-4"}`}>
                      <Chart className="bg-red-300" dataX={item.sparkline_in_7d.price} maintainAspectRatio={false}/>
                    </td>
                    <td className={styles.dataCell}>
                      <a href="#">
                        Edit
