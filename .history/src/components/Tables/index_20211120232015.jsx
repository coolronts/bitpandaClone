...
export default function Tables({
  ...
  const styles = {
    ...
    header: "bg-gray-50",
    scope: "px-12 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider text-center",
                ...
                {items.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className={`${styles.dataCell +  "bg-red-200"}`}>
                      <Chart className="bg-red-300" dataX={item.sparkline_in_7d.price} aspectRatio={6} />
                    </td>
                    <td className={styles.dataCell}>
                      <a href="#">
                        Edit
