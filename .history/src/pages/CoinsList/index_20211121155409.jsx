  ...
  return (
    <div>
      <div className={styles.dayPick}>
          <p onClick={()=>setDay(1)}  className={`${styles.dayOption} ${day==1 ? "bg-green-400" : ""}`}>1D</p>
          <p onClick={()=>setDay(7)} className={`${styles.dayOption} ${day==7 ? "bg-green-400" : ""}`}>7D</p>
          <p onClick={()=>setDay(30)} className={`${styles.dayOption} ${day==30 ? "bg-green-400" : ""}`}>30D</p>
          <p onClick={()=>setDay(365)} className={`${styles.dayOption} ${day==365 ? "bg-green-400" : ""}`}>1Y</p>
      </div>
      <Tables
