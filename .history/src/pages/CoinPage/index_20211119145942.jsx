...
export default function CoinPage() {
  ...
  const ChartContent = () => {
    ...
    function marketChange() {
      setPriceChange(chartHistory[chartHistory[chartHistory.length - 1][1]] - chartHistory[0][1])
      setPercentageChange((chartHistory[chartHistory[chartHistory.length - 1][1]] - chartHistory[0][1])*100/(chartHistory[0][1]))
  }
