            ...
            <section className="px-12">
              <SplitScreen leftWeight={'w-full mr-12'} rightWeight={'w-1/2'}>
                <div id="left">
                  ...
                  <BasicCard>
                    <p className={`text-semibold ${!readMore? "h-48 overflow-ellipsis overflow-hidden":""}`} > {coin.description} </p>
                    <a onClick={()=>setReadMore(!readMore)} className="text-blue-800 font-semibold hover:underline cursor-pointer">Read More</a>
                  </BasicCard>
