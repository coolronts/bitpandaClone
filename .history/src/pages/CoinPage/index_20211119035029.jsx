...
export default function CoinPage() {
  const styles = {
    ...
    priceChange: `text-lg font-bold mb-6 ${coin.dayChange > 0 ? "text-green-500" : "text-red-500"}`,
    dayPick: "flex mt-6",
    dayOption: "text-green-900 bg-green-400 px-2 py-1 text-xs font-bold mr-3 rounded-md shadow-xl"
  }
  const ChartContent = () => {
    return (
