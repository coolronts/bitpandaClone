    ...
    return (
      <div className="mb-12">
        ...
        <div className="flex mt-6">
          ...
          <p className="text-green-900 bg-green-200 px-2 py-1 text-xs font-bold mr-3 rounded-md">7D</p>
          <p className="text-green-900 bg-green-200 px-2 py-1 text-xs font-bold mr-3 rounded-md">30D</p>
          <p className="text-green-900 bg-green-200 px-2 py-1 text-xs font-bold mr-3 rounded-md">1Y</p>
        </div>
      </div>
    )
  }
