  ...
  const CardContent = () => {
    return (
      <>
        ...
        <div className="text-lg font-bold"> {coin.market_data.market_cap_change_percentage_24h_in_currency.nok> 0 && '+'}{coin.market_data.market_cap_change_percentage_24h_in_currency.nok} </div>
