...
import { coinDetails, dayChartData } from '../../api'
...
export default function CoinPage() {
  ...
  const ChartContent = () => {
    ...
    useEffect(() => {
      dayChartData(dayChart).then(res => {
        setDayChartData(res)
      })
    }, [dayChart]);
    ...
    return (
      <div className={styles.body}>
        ...
        <Chart dataX={dayChartData} borderWidth={3}  yGrid={true}  xGrid={true} grid={true} legends={true} tooltipEnable={true} />
