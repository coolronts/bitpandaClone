...
export default function CoinPage({ coinId }) {
  ...
  const CardContent = () => {return(<Chart dataX={chartData} borderWidth={3}  yGrid={true}  xGrid={true} grid={true} legends={true} tooltipEnable={true} />)}
    // <>
    // <div className="text-6xl font-bold"> {coin.market_data} Nok </div>
    //     <div className="text-lg font-bold"> {coin.market_data. > 0 && '+'}{coin.market_data} </div>
