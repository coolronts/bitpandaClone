import { currentPrice, dayChartData, trending } from '../../api'
...
export default function Home() {
  ...
  useEffect(() => {
    trending().then(res => {
      res.map((trend) => {
        ...
        .then(dayChartData(trend.item.id).then(res => {
          detail.chartData = res
  ...
  return (
    <div>
      ...
      <hr />
      <SplitScreen leftWeight={'flex-grow'} rightWeight={'w-1/2'}>
          <MyPortfolio/>
          <CreditCard
