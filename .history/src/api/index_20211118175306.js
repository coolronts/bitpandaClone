...
export async function coinDetails(id) {
  ...
  result.currentPrice = coinDetails.data.market_data.current_price.nok;
  result.dayChange =
    coinDetails.data.market_data.market_data.market_cap_change_24h_in_currency.nok;
  result.dayPercentageChange =
    coinDetails.data.market_data.market_cap_change_percentage_24h_in_currency.nok;
