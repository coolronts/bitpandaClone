...
export async function coinDetails(id) {
  ...
  result.image = coinDetails.data.image.large;
  result.seven_days.chartData = coinDetails.data.market_data.sparkline_7d.price

  
  console.log(coinDetails.data);
  console.log(typeof coinDetails.data.market_data.current_price.nok);
  console.log(typeof coinDetails.data.market_data.current_price);
  return result;
}
