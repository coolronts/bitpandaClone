...
export async function getCoinsList(upperLimit) {
    const lists = await axios.get(
        `${baseLink}coins/markets?vs_currency=nok&sparkline=true&price_change_percentage=7d`
    );
    console.log(lists.data);
    return lists.data.slice(0, upperLimit);
}